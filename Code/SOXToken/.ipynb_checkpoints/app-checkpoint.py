...
student_account = st.selectbox("select Account", accounts)
# Enter a text string for the certificate or link to digital certificate location
certificate_details = st.text_input("ceertificate details", value = "finTech Certificate of completion")
...
if st.button("Display Certificate"):
    ...
    certificate_uri = contract.functions.tokeURI(certificate_id).call()
